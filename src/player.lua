function initPlayer()
	...
	player = {pos = {x = 240, y = 135}, speed = 2, aim = {x = 0, y = 0}, radius = 16, target = {x = 240, y = 135}, inertia = 0.1, aimAngle = 0, magfieldsActive = false, maxHP = 10, hpBarTarget = { x = 0, y = -17 }, hpBarInertia = 0.4, takingDamage = false }
